...
//
// phase14-09 收缩：画像写路径与两组 bindings 已由 Standard 实体承接，
// 模块收敛为纯读，哨兵只保留读取失败语义两条。
// 这些哨兵错误由 service / repository 层返回，由消费方 Connect handler 统一
...
var (
	...
	// ErrGovernanceProfileReadFailed 治理画像主记录读取失败。
